...
// home
await page.screenshot({ path: OUT + "hero2_home.png" });

// click pool node (3rd)
const btns = await page.$$('section button[aria-pressed]');
if (btns[2]) { await btns[2].click(); await new Promise((r) => setTimeout(r, 1200)); await page.screenshot({ path: OUT + "hero2_pool.png" }); }
